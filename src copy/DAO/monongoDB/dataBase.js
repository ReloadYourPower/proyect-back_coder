...
async  readProductByCode(databaseName, collectionName, productCode) {
    try {
...
async updateProductByCode(databaseName, collectionName, productCode, newData) {
    try {
...
async deleteProductByCode(databaseName, collectionName, productCode) {
    try {
